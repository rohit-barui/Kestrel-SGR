...
class TestPerception(unittest.TestCase):
    ...
    def test_extract_urls(self):
        payload = {"output": {"content": "Visit https://example.com and http://test.org"}}
    ...
    def test_whois_lookup_cache(self):
        payload = {"output": {"domains": ["example.com"]}}
        first = whois_lookup(payload)
        second = whois_lookup(payload)  # should hit cache, same result
    ...
    def test_detect_typo_squatting(self):
        payload = {"output": {"domains": ["examp1e.com", "legit.com"]}}
